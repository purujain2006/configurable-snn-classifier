...
{n:"TrainSpec", k:"dataclass", s:"epochs, optimizer, lr, weight_decay, scheduler, warmup_epochs, label_smoothing, grad_clip, qat_mode, qat_warmup_frac, qat_epochs, qat_lr_scale, fold_bias_mode", o:"The optimization recipe, covering everything that affects training but not shape.",
...
{n:"_ste", k:"function", s:"_ste(quantized, original) = original + (quantized - original).detach()", o:"Straight-through estimator: the quantized value forward, the gradient to the float parameter backward.",
 b:"Used for weight quantization, threshold quantization and the learned integer leak. See <a href='hardware.html#ste'>4.4</a>."},
