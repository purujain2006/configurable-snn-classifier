...
PATCHES = {
    ...
    "train.py": [
        ...
        ('def train_one_epoch(net, loader, optimizer, device, criterion=None,\n'
         ...
         '        # Every spiking layer EXCEPT the last. The final layer\'s spikes\n'
         '        # are the prediction, so penalizing them asks the network to stop\n'
         '        # answering. Measured: 0.332 accuracy at epoch 9 with the penalty\n'
         '        # on against 0.626 without, and 92% killed at the first rung.\n'
         '        for m in nodes[:-1]:\n'
